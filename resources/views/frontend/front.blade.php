    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="{{ asset('assets/frontend/img/bg-img/add.png')}}" alt=""></a>
            </div>
                                ...
                                <div class="single--slide">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{ asset('assets/frontend/img/bg-img/23.jpg')}}" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{ asset('assets/frontend/img/bg-img/24.jpg')}}" alt="">
                                        </div>
                                        <div class="post-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/frontend/img/bg-img/31.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/frontend/img/bg-img/32.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/frontend/img/bg-img/33.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/frontend/img/bg-img/34.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
