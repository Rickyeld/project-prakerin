    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Global Travel And Vacations Luxury Travel</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Cruising Destination Ideas</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">The Luxury Of Traveling With</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Choose The Perfect Accommodations</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="{{ asset('assets/img/bg-img/add.png')}}" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Coventry City Guide Including Coventry</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Get Ready Fast For Fall Leaf Viewing</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Global Resorts Network Grn Putting</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                ...
                <div class="single-blog-post d-flex">
                    ...
                    <div class="post-content">
                        <a href="{{url('single-post')}}" class="post-title">Travel Prudently Luggage And Carry</a>
                        <div class="post-meta d-flex justify-content-between">
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
        ...
        <div class="mag-posts-content mt-30 mb-30 p-30 box-shadow">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="{{ asset('assets/img/bg-img/20.jpg')}}" alt="">
                        <div class="post-content">
                            ...
                            <div class="featured-video-posts-slide owl-carousel">
                                ...
                                <div class="single--slide">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        ...
                                        <div class="post-content">
                                            <a href="{{url('single-post')}}" class="post-title">Global Resorts Network Grn Putting Timeshares To Shame</a>
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{ asset('assets/img/bg-img/24.jpg')}}" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="{{url('single-post')}}" class="post-title">A Guide To Rocky Mountain Vacations</a>
                                            <div class="post-meta d-flex">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        ...
                                        <div class="post-content">
                                            <a href="{{url('single-post')}}" class="post-title">American Standards And European Culture How To Avoid</a>
                                            <div class="post-meta d-flex">
                                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1034</a>
                                                <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 834</a>
                                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 234</a>
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{ asset('assets/img/bg-img/26.jpg')}}" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="{{url('single-post')}}" class="post-title">Mother Earth Hosts Our Travels</a>
                                            <div class="post-meta d-flex">
                                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1034</a>
                                                <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 834</a>
                                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 234</a>
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="{{ asset('assets/img/bg-img/27.jpg')}}" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                            <div class="post-meta d-flex">
                                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 1034</a>
                                                <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 834</a>
                                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 234</a>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/img/bg-img/31.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/img/bg-img/32.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/img/bg-img/33.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="{{ asset('assets/img/bg-img/34.jpg')}}" alt="">
                            </div>
                            <div class="post-content">
                                <a href="{{url('single-post')}}" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="{{url('single-post')}}" class="channel-title">TV Show</a>
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="{{url('single-post')}}" class="channel-title">Game Channel</a>
                        <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                    </div>
                </div>
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="{{url('single-post')}}" class="channel-title">Sport Channel</a>
                        <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                    </div>
                </div>
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="{{url('single-post')}}" class="channel-title">Travel Channel</a>
                        <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                    </div>
                </div>
                ...
                <div class="single-youtube-channel d-flex">
                    ...
                    <div class="youtube-channel-content">
                        <a href="{{url('single-post')}}" class="channel-title">LifeStyle Channel</a>
                        <a href="#" class="btn subscribe-btn"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Subscribe</a>
                    </div>
                </div>
